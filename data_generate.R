...
# beta0, beta1: parameters used to calculate inclusion probabilities
# n : sample size
# N : population size
data_normal = function(mu_x, mu_z, s_x, s_z, rho, beta0, beta1, n, N){
  ...
  # pi = \Phi(\beta_0 + \beta_1*Z)
  sel.prob = pnorm(beta0 + beta1*data.pop[ , "Z"])
